...
const { find, isEmpty, join } = require('lodash/fp')
...
class WindowManager {
  ...
  parseWindow(line) {
    const [windowId, desktopId, clientMachine, ...windowTitlePieces] = columns(line)
    const windowTitle = join(' ', windowTitlePieces)
